...
topic(
    ...
    [
        slider("h1", "2024년 서울에서 열대야(밤 최저기온 25도 이상)는 며칠이었을까요?",
               ...
               "열대야는 7월 27일부터 8월 22일 사이에 몰려 있지만, 그 27일 구간 "
               "중 절반 남짓인 15일만 기준을 채웁니다."),
        ...
        choice("h4", "최근 30년간 33도 이상인 날이 가장 잦았던 날짜는?",
               ...
               "최근 30년(1995~2024년)의 33도 이상 기록을 날짜별로 모아 보면, "
               "8월 5일이 6회로 가장 잦았습니다."),
        slider("h5", "2024년 서울에서 밤 기온이 영하로 내려간 날은 며칠이었을까요?",
               below0_24, "일", 30, 150, 5,
               f"2024년 일최저기온 0도 미만인 날 {below0_24}일",
               "2024년 한 해에만 서울의 밤 최저기온이 영하로 내려간 날이 110일로, "
               "366일 중 거의 3분의 1을 차지합니다."),
    ],
    caveat="이 수치는 넓은 지역을 격자로 계산한 ERA5 재분석 값입니다. 실제 "
           "기상 관측소에서 측정한 값과는 차이가 있을 수 있으므로, 서울의 "
           "특정 관측지점에서 실제 측정된 기온과 동일한 값으로 해석하면 "
           "안 됩니다.")
